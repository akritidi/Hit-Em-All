...
public class ScoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
          Λούπα για την εμφάνιση των εγγραφών στα Text Views. Η λούπα θα εκτελεστεί από 0 (άδεια βάση) εώς 10 φορές (γεμάτη βάση - maximum "σταθερό μέγεθος" 10 εγγραφές
          Σε κάθε επανάληψη ανατίθεται στο αντικειμενο η κατάλληλη εγγραφή από την βάση (βλ. highScores), και εμφανίζει στα κατάλληλα text views την τιμή του ονοματος και του σκορ της εγγραφή
          */
