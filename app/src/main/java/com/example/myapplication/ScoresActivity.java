...
public class ScoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
          Συνθήκη επανάληψης για την εμφάνιση των εγγραφών στα Text Views. Η λούπα θα εκτελεστεί από 0 (άδεια βάση) εώς 10 φορές (γεμάτη βάση - maximum "σταθερό μέγεθος" 10 εγγραφές.
          Σε κάθε επανάληψη ανατίθεται στο αντικείμενο η κατάλληλη εγγραφή από την βάση (βλ. highScores), και εμφανίζει στα κατάλληλα text views την τιμή του ονόματος και του σκορ της εγγραφής
          */
